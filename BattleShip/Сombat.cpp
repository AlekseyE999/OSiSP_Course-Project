...
int Combat::magicKoord(int i, int j)
{
	int res;
	if (i != 0) res = i * 10 + j;
	else res = j;
...
int Combat::correctKoord(int player, int i, int j)
{
...
void Combat::MarkKoord(int player, int i, int j)
{
...
void Combat::randomships(int player)
{
